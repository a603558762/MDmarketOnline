var vm = new Vue({
    ...
    mounted: function(){
        ...
        axios.get(this.hosts + '/oauth/qq/user/?code=' + code, {
                responseType: 'json',
            })
            .then(response => {
    ...
    methods: {
        ...
        send_sms_code: function(){
            ...
            axios.get(this.hosts + '/smscode/' + this.mobile + '/?text=' + this.image_code+'&uuid='+ this.image_code_id, {
                    responseType: 'json'
                })
                .then(response => {
                    // 表示后端发送短信成功
        ...
        on_submit: function(){
            ...
            if(this.error_password == false && this.error_phone == false && this.error_sms_code == false) {
                axios.post(this.hosts + '/oauth/qq/user/', {
